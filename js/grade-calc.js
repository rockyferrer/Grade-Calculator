...
//var resultEl = document.getElementById('result') || document.getElementById('errorMessage');
//resultEl.addEventListener('click', outputMessage, false);
